		...
		if ($this->session->userdata('id_level') == '2' || $this->session->userdata('id_level') == '5' ) { ?>
			...
			<div class="col-xl-6">
				...
				<div class="card-header">
					...
					<div class="card-body">
					<form method="post" action="<?php echo base_url("Penggunaan/form"); ?>" enctype="multipart/form-data">
						<!--
						...
						<div class="row mt-4">
							<div class="col-sm-6">
								...
								<a href="<?= base_url('Penggunaan/export_excel') ?>" class="btn btn-primary">Export format</a>
							</div>
						</div>
					</form>
					</div>
