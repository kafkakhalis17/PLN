      ...
      <tr>
         <td style="padding-left:20px;">
            <p style="font-size:14px;font-family:Arial,Helvetica,sans-serif;">
               Pendaftaran pasang baru anda baru saja di tolak <br>
               dengan pelanggan atas nama <b><?= $namapelanggan ?></b>, Pemasangan dan Pendaftaran anda baru saja 
               Ditolak Karena Tidak Sesuai dengan aturan yang berlaku, silakan hubungi  <br>pihak kami untuk info lebih lanjut.
            </p>
