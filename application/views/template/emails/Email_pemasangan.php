...
<body>
   <table style="width:538px;" align="center" cellspacing="0" cellpadding="0">
      ...
      <tr>
         <td style="padding:20px 20px 10px 20px;"><span style="font-size:24px;font-family:Arial,Helvetica,sans-serif;font-weight:bold">Pemasangan Daya</span></td>
      </tr>
      <tr>
         <td style="padding-left:20px;">
            <p style="font-size:14px;font-family:Arial,Helvetica,sans-serif;">
               ...
               dengan pelanggan atas nama <b><?= $namapelanggan ?></b>, Pemasangan dan Pendaftaran anda baru saja 
               berhasil dilakukan, berikut detail data anda.
            </p>
            <table style="font-size:14px;font-family:Arial,Helvetica,sans-serif;">
               <tr>
                  <td style="padding:20px 0px 0px 20px;">NO KWh</td>
                  <td style="padding:20px 0px 0px 20px;"><?= $nokwh ?></td>
               </tr>
               <tr>
               ...
               <tr>
                  <td style="padding:20px 0px 0px 20px;">Daya</td>
                  <td style="padding:20px 0px 0px 20px;"><?= $daya?></td>
               </tr> 
            </table>
         </td>
         <tr>
            <td style="padding-left:20px;">
               <h5>Terima Kasih Telah menggunakan layanan kami, gunakanlah listrik sebijak mungkin</h5>
            </td>
         </tr>
      </tr>
   </table>
